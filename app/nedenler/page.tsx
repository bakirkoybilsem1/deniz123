  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--ocean-deep)' }}>
      ...
      <section style={{
        ...
        textAlign: 'center',
        background: 'radial-gradient(ellipse at 50% 80%, rgba(0,180,216,0.1) 0%, transparent 58%)',
        ...
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              marginBottom: 8,
            }}>📋 Araştırma Soruları</div>
            <p style={{ fontSize: 14, color: 'rgba(202,240,248,0.75)', lineHeight: 1.6, marginBottom: 6 }}>
              1. Deniz kirliliği nedir? Konusundaki görüşleriniz neler?
            </p>
            <p style={{ fontSize: 14, color: 'rgba(202,240,248,0.75)', lineHeight: 1.6, marginBottom: 6 }}>
              2. Deniz kirliliğinin nedenleri neler olabilir?
            </p>
            <p style={{ fontSize: 14, color: 'rgba(202,240,248,0.75)', lineHeight: 1.6 }}>
              3. Deniz kirliliği, deniz canlılarını nasıl etkilemektedir?
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 820, margin: '0 auto' }}>
          <div style={{
            ...
            <div style={{
              ...
              letterSpacing: '0.08em',
              marginBottom: 12,
            }}>BM Deniz Hukuku Sözleşmesi — Resmi Tanım</div>
            <p style={{
              fontSize: 16,
              ...
              "Deniz çevresinin kirlenmesi; insanların, doğrudan veya dolaylı olarak canlı kaynaklara, insan sağlığına, balıkçılık dâhil denizcilik faaliyetlerine engel olması, deniz suyunun kullanımında kalitenin bozulması ve görsel güzelliklerin azalması gibi zararlı etkilerle sonuçlanan madde veya enerjinin deniz çevresine girmesi."
            </p>
            <p style={{ fontSize: 12, color: 'rgba(202,240,248,0.45)', marginTop: 10 }}>
              Kaynak: BMDHS Madde 1/(4) · Tabanlı & Güneysu, 2021
            </p>
          </div>
        </div>
      </section>
            ...
            {NEDENLER.map((n, i) => (
              <div key={i} className="card-ocean" style={{ padding: '22px 20px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
                  ...
                  <div>
                    ...
                    <div style={{
                      ...
                      border: '1px solid rgba(139,69,19,0.38)',
                      borderRadius: 10,
                      padding: '2px 10px',
                      fontSize: 11,
                      color: '#e8a87c',
                ...
                <p style={{
                  ...
                  marginBottom: 8,
                  fontStyle: 'italic',
                  borderLeft: '2px solid rgba(0,180,216,0.25)',
                  paddingLeft: 10,
                }}>{n.desc}</p>
      ...
      <section style={{ padding: '55px 24px', background: 'rgba(13,33,55,0.7)' }}>
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(202,240,248,0.5)', fontSize: 14, textAlign: 'center', marginBottom: 32 }}>
            Katılımcıların son test cevaplarından
          </p>
...
with open('/mnt/agents/output/nedenler_page.tsx', 'w', encoding='utf-8') as f:
    f.write(nedenler_page)

print("✅ nedenler/page.tsx yazıldı")
