...
const NAV_ITEMS = [
  ...
  { label: 'Quiz & Oyunlar', href: '/oyunlar' },
]
...
const FEATURES = [
  { icon: '🌊', title: 'Deniz Kirliliği Nedir?', desc: 'BM tanımı, Marmara Denisi\'nin durumu, kirlilik türleri ve ekosisteme etkileri.', href: '/nedenler', bg: 'rgba(0,180,216,0.1)', border: 'rgba(0,180,216,0.3)' },
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--ocean-deep)' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 840 }}>
          ...
          <p style={{
            ...
            İstanbul'un 9 farklı ilçesinden 27 yetişkinle yürütülen araştırmanın bulgularına dayanan bu platform;
            deniz kirliliği, müsilaj ve su ayak izi konularında farkındalık kazandırmayı amaçlıyor.
          </p>
          <p style={{
            fontSize: 14,
          ...
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <Link href="/oyunlar">
              <button style={{
                ...
                color: 'var(--ocean-foam)',
                border: '1.5px solid rgba(0,180,216,0.42)',
                padding: '12px 26px',
                borderRadius: 50,
                fontSize: 15,
                fontWeight: 600,
              ...
              onMouseOut={e => {
                ...
                e.currentTarget.style.borderColor = 'rgba(0,180,216,0.42)'
              }}>
                🎮 Quiz'e Katıl
              </button>
            </Link>
        ...
        <div style={{ maxWidth: 1080, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 44 }}>
            <div style={{
              ...
              border: '1px solid rgba(139,69,19,0.42)',
              borderRadius: 20,
              padding: '5px 16px',
              fontSize: 11,
              fontWeight: 700,
            ...
            <p style={{ color: 'rgba(202,240,248,0.5)', marginTop: 10, fontSize: 14 }}>
              Nitel araştırma · Durum çalışması deseni · İstanbul, 35–65 yaş
            </p>
          </div>
              ...
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    letterSpacing: '0.08em',
                    marginBottom: 7,
                  }}>{item.icon} Ön Test — {item.topic}</div>
                  <p style={{
                    fontSize: 14,
                    color: 'rgba(202,240,248,0.7)',
                    fontStyle: 'italic',
              ...
              <Link key={i} href={f.href} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  onMouseOver={e => {
                    ...
                    e.currentTarget.style.boxShadow = `0 12px 36px ${f.border}`
                  }}
                  onMouseOut={e => {
            ...
            {[
              ...
              <Link key={item.n} href={item.href} style={{ textDecoration: 'none' }}>
                <div style={{
                  ...
                  borderRadius: 11,
                  textAlign: 'left',
                  background: 'rgba(14,61,92,0.32)',
                  border: '1px solid rgba(0,180,216,0.13)',
                  transition: 'all 0.2s',
                }}
                  onMouseOver={e => {
                    e.currentTarget.style.background = 'rgba(14,61,92,0.52)'
                    e.currentTarget.style.borderColor = 'rgba(0,180,216,0.38)'
                  }}
                  onMouseOut={e => {
                    e.currentTarget.style.background = 'rgba(14,61,92,0.32)'
                    e.currentTarget.style.borderColor = 'rgba(0,180,216,0.13)'
                  }}>
                  <div style={{
                    minWidth: 30,
                    height: 30,
      ...
      <section style={{
        ...
        background: 'linear-gradient(135deg,rgba(0,180,216,0.08) 0%,rgba(26,107,138,0.12) 100%)',
      }}>
        <div style={{ maxWidth: 580, margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(202,240,248,0.4)', fontSize: 13, fontStyle: 'italic', marginBottom: 34 }}>
            "Bu kitapçık MEB EBA sistemine entegre edilerek veli-öğrenci ortak etkinlikleri kapsamında değerlendirilebilir." — Araştırma
          </p>
          <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
      ...
      <footer style={{
        ...
        <p style={{
          ...
          marginBottom: 4,
        }}>🌊 Deniz Kirliliğiyle Mücadele Kiti</p>
...
print("✅ page.tsx (Ana Sayfa) yazıldı")
