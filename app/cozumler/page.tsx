...
const ONERILER = [
  ...
  { icon: '🏫', text: 'MEB EBA sistemine entegrasyon ile daha fazla kişiye ulaşmak mümkün.' },
]
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--ocean-deep)' }}>
      ...
      <section style={{
        ...
        textAlign: 'center',
        background: 'radial-gradient(ellipse at 50% 80%, rgba(45,106,79,0.12) 0%, transparent 58%)',
        ...
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          ...
          <p style={{
            ...
            "Deniz kirliliğinin önlenmesi için bireysel olarak neler yapılabilir?" — Araştırmaya
            katılan 27 yetişkinin ön test ve son test cevaplarından derlendi.
          </p>
          <div style={{
            ...
            <p style={{
              ...
              fontStyle: 'italic',
            }}>"Deniz kirliliğinin önlenmesi için bireysel olarak neler yapılabilir?"</p>
          </div>
        </div>
      </section>
...
with open('/mnt/agents/output/cozumler_page.tsx', 'w', encoding='utf-8') as f:
    f.write(cozumler_page)

print("✅ cozumler/page.tsx yazıldı")
