  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--ocean-deep)' }}>
      ...
      <section style={{
        ...
        background: 'radial-gradient(ellipse at 50% 80%, rgba(231,76,60,0.08) 0%, transparent 60%)',
      }}>
...
with open('/mnt/agents/output/musilaj_page.tsx', 'w', encoding='utf-8') as f:
    f.write(musilaj_page)

print("✅ musilaj/page.tsx yazıldı")
